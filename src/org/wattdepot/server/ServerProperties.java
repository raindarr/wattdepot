...
/**
 * Provides access to the values stored in the wattdepot-server.properties file. Portions of
...
public class ServerProperties {
  ...
  /**
   * Reads in the properties in ~/.wattdepot/wattdepot-server.properties if this file exists,
   * and provides default values for all properties not mentioned in this file.
   * Will also add any pre-existing System properties that start with "wattdepot-server.".
   * 
  ...
  private void initializeProperties () throws Exception {
    ...
    properties.setProperty(DB_IMPL_KEY, "org.wattdepot.server.db.derby.DerbyImplementation");
...
//    System.setProperties(systemProperties);
  ...
  /**
   * Finds any System properties whose key begins with "wattdepot-server.", and adds those
   * key-value pairs to the passed Properties object.
   * 
   * @param properties The properties instance to be updated with the WattDepot system 
   * properties.
   */
  ...
  /**
   * Returns the fully qualified host name, such as "http://localhost:9876/sensorbase/". Note,
   * the String will end with "/", so there is no need to append another if you are constructing
   * a URI.
   * 
