...
//
//  /**
//   * Returns true if the passed host is a WattDepot host. The timeout is set at the default
//   * timeout value. Since checking isHost() when the host is not available is expensive, we cache
//   * the timestamp whenever we find the host to be unavailable and if there is another call to
//   * isHost() within two seconds, we will immediately return false. This makes startup of clients
//   * like SensorShell go much faster, since they call isHost() several times during startup.
//   * 
