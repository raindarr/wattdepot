 ...
 */
public class EnergyCounterPropertyAdder {
  ...
  /** Name of this tool. */
  private static final String toolName = "EnergyCounterPropertyAdder";
  ...
  /**
   * Creates the new EnergyCounterPropertyAdder client.
   * 
   ...
   */
  public EnergyCounterPropertyAdder(String propertyFilename, String uri, boolean dryRun) throws IOException {
  ...
  public static void main(String[] args) {
    ...
    EnergyCounterPropertyAdder energyCounterPropertyAdder = null;
    try {
      energyCounterPropertyAdder = new EnergyCounterPropertyAdder(propertyFilename, uri, dryRun);
    }
    catch (IOException e) {
    ...
    // Just do it
    if ((energyCounterPropertyAdder != null) && (energyCounterPropertyAdder.process())) {
