...
public class TestDerbyStorageImplementation extends DbManagerTestHelper {
  /**
   * Tests the makeSnapshot method. Checks to see if the modification date of the backup log is
   * updated by the method as a quick check that something happened.
   * 
   * @throws InterruptedException If sleep kludge is interrupted.
   */
  @Test
  public void testMakeSnapshot() throws InterruptedException {
